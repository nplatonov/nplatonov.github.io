...
states <- st_read(file.path(root, "10m_cultural", "ne_10m_admin_1_states_provinces.shp.zip"))
rivers <- st_read(file.path(root, "10m_physical", "ne_10m_rivers_lake_centerlines.shp.zip"))
cities <- st_read(file.path(root, "10m_cultural", "ne_10m_populated_places_simple.shp.zip"))
