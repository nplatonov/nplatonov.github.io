...
oceans <- ursa::spatial_read(file.path(root, "10m_physical", "ne_10m_geography_marine_polys"))

rivers <- ursa::spatial_read(file.path(root, "10m_physical", "ne_10m_rivers_lake_centerlines"))
...
ggsave(filename = "./Australia1_reproduced.png", 
