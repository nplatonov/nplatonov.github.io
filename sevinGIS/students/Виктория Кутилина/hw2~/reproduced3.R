...
p <- ggplot() +
  geom_sf(data = bathy_0, fill = "#E6F3FF", color = NA, alpha = 0.5) +
  geom_sf(data = bathy_200, fill = "#CCE5FF", color = NA, alpha = 0.7) +
  geom_sf(data = bathy_1000, fill = "#B3D9FF", color = NA, alpha = 0.9) +
  geom_sf(data = bathy_2000, fill = "#99CCFF", color = NA, alpha = 0.9) +
  geom_sf(data = bathy_3000, fill = "#80BFFF", color = NA, alpha = 0.9) +
  geom_sf(data = bathy_4000, fill = "#66B2FF", color = NA, alpha = 0.9) +
  geom_sf(data = bathy_5000, fill = "#4DA6FF", color = NA, alpha = 0.9) +
...
print(p)
#+
ggsave(filename = "Australia3_reproduced.png",
