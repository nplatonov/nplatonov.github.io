...
path <- "G:/layers/" 
states_all <- read_sf(paste0(path, "ne_10m_admin_1_states_provinces.shp"))
rivers_all <- read_sf(paste0(path, "ne_10m_rivers_lake_centerlines.shp"))
lakes_all  <- read_sf(paste0(path, "ne_10m_lakes.shp"))
...
ggsave("australia_perfect_final.png", plot = final_plot, width = 11, height = 8, dpi = 300)
