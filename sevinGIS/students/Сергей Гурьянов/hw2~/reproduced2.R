...
ggsave("australia2_reproduced_albers_3577_curved.png", map_final, width = 15, height = 12, dpi = 100, bg = "white")
cairo_pdf("australia2_reproduced_albers_3577_curved.pdf", width = 15, height = 12)
print(map_final)
dev.off()
