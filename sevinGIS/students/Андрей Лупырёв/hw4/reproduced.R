...
countries <- ursa::spatial_read(file.path(root, "10m_cultural", "ne_10m_admin_0_countries_arg.shp"))
label <- ursa::spatial_read(file.path(root, "10m_cultural", "ne_10m_admin_1_label_points_details.shp"))
states <- ursa::spatial_read(file.path(root, "10m_cultural", "ne_10m_admin_1_states_provinces_lines.shp"))
provinces <- ursa::spatial_read(file.path(root, "10m_cultural", "ne_10m_admin_1_states_provinces.shp"))
marine <- ursa::spatial_read(file.path(root, "10m_physical", "ne_10m_geography_marine_polys.shp"))
...
lakes <- ursa::spatial_read(file.path(root, "10m_physical", "ne_10m_lakes_australia.shp"))
